...
const GameBoard = ({ turn, pieces, movedPiece, selectedPiece }) => {
    ...
    const getLighterShade = (baseColor) => {
        switch(baseColor) {
            case "#4CAF50": // Green
                return "#81c784";  // Much lighter green
            case "#2196F3": // Water blue
                return "#64b5f6";  // Much lighter blue
            case "#FFC107": // Trap yellow
                return "#ffd54f";  // Much lighter yellow
            case "#9C27B0": // Den purple
                return "#ce93d8";  // Much lighter purple
            default:
                return baseColor;
        }
    };
